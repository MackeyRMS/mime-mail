...
spec = describe "Network.Mail.Mime" $ do
    describe "quotedPrintable" $ do
        ...
        it "example from Wikipedia" $
            let enc = if maxCol == 74
                      then "If you believe that truth=3Dbeauty, then surely mathematics is the most b=\r\neautiful branch of philosophy=2E" 
        ...
        it "issue #17- as text" $
            let enc = if maxCol == 74
                      then "</a>=E3=81=AB=E3=81=A4=E3=81=84=E3=81=A6=E3=81=AE=E3=83=86=E3=82=B9=E3=83=\r\n=88"
